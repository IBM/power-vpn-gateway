...
| <a name="input_preshared_key"></a> [preshared\_key](#input\_preshared\_key) | Key configured on the peer gateway. The key is usually a complex string similar to a password, for example: 3j9atsxOzAtr1O1VEY.<br><br>Preshared key must be at least 16 characters. | `string` | n/a | yes |
